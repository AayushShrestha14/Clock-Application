package com.example.clockapplication.util;
...
import com.example.clockapplication.Appstaticants;
import com.example.R;
import com.example.TimerActivity;
import com.example.TimerNotificationActionReceiver;
...
class NotificationUtil {
    ...
    Context context;
    companion object {
        private static val CHANNEL_ID_TIMER = "menu_timer"
        private static val CHANNEL_NAME_TIMER = "Timer App Timer"
        private static val TIMER_ID = 0

        fun showTimerExpired(Context context){
            val startIntent = Intent(context, TimerNotificationActionReceiver::class.java)
            startIntent.action = Appstaticants.ACTION_START
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            stopIntent.action = Appstaticants.ACTION_STOP
            val stopPendingIntent = PendingIntent.getBroadcast(context,
                    0, stopIntent, PendingIntent.FLAG_UPDATE_CURRENT)

            val pauseIntent = Intent(context, TimerNotificationActionReceiver::class.java)
            pauseIntent.action = Appstaticants.ACTION_PAUSE
        ...
        fun showTimerPaused(context: Context){
            ...
            resumeIntent.action = Appstaticants.ACTION_RESUME
